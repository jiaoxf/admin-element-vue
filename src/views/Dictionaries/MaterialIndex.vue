...
export default {
    ...
    methods: {
        ...
        downTemplate() {
            this.$api.materialsIndexTemplate({}).then(res => {
                console.log(res)
                if (res.code == 'SUCCESS') {
        ...
        exportFunction() {
            ...
            let params = {
                ...
                materialName: this.form.materialName, //产品名称
            ...
            axios({
                method: 'post',
                url: `${this.$baseUrl}/web/materialsIndex/export`,
                headers: {
        ...
        uploadFileChange() {
            ...
            this.$api.materialsIndexImport(formData).then(res => {
                console.log(res)
                if (res.code == 'SUCCESS') {
