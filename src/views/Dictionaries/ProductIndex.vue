        ...
        <div class="page-body">
            <div class="page-table">
                ...
                >
                    ...
                    <template slot-scope="" slot="productNameSearch">
                        <el-input
                    ...
                    <template slot-scope="" slot="productSizeSearch">
                        <el-input
                    ...
                    <template slot-scope="" slot="productIdSearch">
                        <el-input
...
export default {
    ...
    methods: {
        ...
        downTemplate() {
            this.$api.productIndexTemplate({}).then(res => {
                console.log(res)
                if (res.code == 'SUCCESS') {
        ...
        exportFunction() {
            ...
            axios({
                method: 'post',
                // url: 'http://www.cdraindrop.top/web/productIndex/export',
                url: `${this.$baseUrl}/web/productIndex/export`,
                headers: {
        ...
        uploadFileChange() {
            ...
            this.$api.productIndexImport(formData).then(res => {
                console.log(res)
                if (res.code == 'SUCCESS') {
