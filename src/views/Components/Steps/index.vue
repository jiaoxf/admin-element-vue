  ...
  <div class="element-container">
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        ...
        <steps-component :stepActive="active" :stepInfo="dataInfo" faDirection="vertical" faSpace="100px"/>
        <steps-component :stepActive="active" :stepInfo="dataInfo1" faDirection="vertical" faSpace="100px"/>
        <steps-component :stepActive="active" :stepInfo="dataInfo" faSuccess="success" :faSimple="simple" :textAlign="false"/>
        <steps-component :stepActive="active" :stepInfo="dataInfo1" faSuccess="success" :faSimple="simple" :textAlign="false"/>
        ...
        <el-button style="margin-top: 12px;" v-if="active !== 1" @click="last">上一步</el-button>
        <el-button style="margin-top: 12px;" v-if="active !== 3" @click="next">下一步</el-button>
        <el-button style="margin-top: 12px;" v-if="active === 3" @click="submit">完成</el-button>
