    ...
    <div class="page-container">
        <div class="page-header">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>辅料质量记录</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="page-body">
...
export default {
        ...
        return {
            ...
            option: {
                ...
                group: [
                    ...
                    {
                        label:
                            '分析指标（选择辅料名称后，带出该辅料的质量分析指标，人工录入分析数值）',
                        prop: 'tksq',
    ...
    methods: {
        ...
        selectMaterial(val) {
            ...
            this.getAccessoryIndex(this.form.accessoryName)
            this.getAccessoryInfo(this.form.accessoryName)
        },
        ...
        getAccessoryInfo(accessoryName) {
            this.$api
                .ingredientsQualityData({
                    accessoryName
                })
                .then(res => {
        ...
        getData() {
            this.loading = true
            this.$api
                .ingredientsQualityList({
                    accessoryName: this.form.accessoryName, //辅料名称
        ...
        filteringredientsQuality(obj, str) {
            const object = {}
            Object.keys(obj)
        ...
        handleSave(form, done, loading) {
            let ingredientsQualityList = this.filteringredientsQuality(this.form, this.indexStr)
            let materialIndexList = this.fileterMaterialIndexList(this.form, this.indexStr)
            console.log(ingredientsQualityList)
            let params = {
                accessoryQuality: ingredientsQualityList,
                accessoryQualityIndexList: materialIndexList
            }
            this.$api.ingredientsQualityAdd(params).then(res => {
                if (res.code == 'SUCCESS') {
