    ...
    <div class="table">
        <el-table id="iTable" v-loading="mTable.loading" :data.sync="data" :stripe="mTable.stripe">
            ...
            <div v-for="items in column" :key="items">
                <el-table-column :prop="items.prop" :label="items.label" v-if="items.slectList">
                    <template slot="header" slot-scope="scope">
                        ...
                        >
                            <el-option
                                v-for="item1 in items.slectList"
                                :key="item1.value"
                                :label="item1.label"
                                :value="item1.value"
                            ></el-option>
                ...
                >
                    <template slot-scope="scope">
                        ...
                        <span
                            ...
                            v-html="item.formatter(scope.row, column)"
